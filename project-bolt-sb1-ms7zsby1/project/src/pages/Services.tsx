...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-800 to-violet-700">
      {/* Hero Section */}
      <section className="py-20 relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-96 h-96 bg-blue-400/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-violet-400/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 hover:transform hover:scale-105"
              >
            ...
            {howItWorks.map((step, index) => (
              <div key={index} className="text-center">
                <div className="relative mb-6">
                  <div className="w-16 h-16 bg-white/20 backdrop-blur-lg rounded-full shadow-lg flex items-center justify-center mx-auto mb-4 border border-white/30">
                    {step.icon}
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    {step.step}
                  </div>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            {stats.map((stat, index) => (
              <div key={index} className="text-center transform hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-xl font-semibold text-orange-100 mb-1">
                  {stat.label}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-white/20">
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-white/20 backdrop-blur-lg p-6 rounded-xl shadow-md text-center border border-white/30">
                ...
                <div className="bg-white/20 backdrop-blur-lg p-6 rounded-xl shadow-md text-center border border-white/30">
                  ...
                  <div className="text-blue-200">Books Analyzed</div>
                </div>
                <div className="bg-white/20 backdrop-blur-lg p-6 rounded-xl shadow-md text-center border border-white/30">
                  <Video className="h-8 w-8 text-indigo-400 mx-auto mb-3" />
                  <div className="text-2xl font-bold text-white">5K+</div>
                  <div className="text-blue-200">Video Resources</div>
                </div>
                <div className="bg-white/20 backdrop-blur-lg p-6 rounded-xl shadow-md text-center border border-white/30">
